...
namespace UIAssistant
{
    ...
    [AddComponentMenu("UI Assistant/Colored Input Field"), RequireComponent(typeof(GraphicColorizerGroup)), DisallowMultipleComponent]
    public class ColoredInputField : TMP_InputField, ISelectableScalerController
    {
        #region Variables
