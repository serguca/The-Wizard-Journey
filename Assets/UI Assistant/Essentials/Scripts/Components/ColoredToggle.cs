...
namespace UIAssistant
{
    ...
    [AddComponentMenu("UI Assistant/Colored Toggle"), RequireComponent(typeof(GraphicColorizerGroup)), DisallowMultipleComponent]
    public class ColoredToggle : Toggle, ISelectableScalerController
    {
        #region Variables
