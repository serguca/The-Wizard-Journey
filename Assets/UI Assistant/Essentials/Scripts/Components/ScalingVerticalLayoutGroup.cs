...
namespace UIAssistant
{
    ...
    [AddComponentMenu("UI Assistant/Scaling Vertical Layout Group"), DisallowMultipleComponent]
    public class ScalingVerticalLayoutGroup : VerticalLayoutGroup, IScaleable
    {
        #region Variables
        ...
        /// <summary>
        /// Updates the Vertical Layout Group's spacing and padding values based on the Scale Settings.
        /// </summary>
