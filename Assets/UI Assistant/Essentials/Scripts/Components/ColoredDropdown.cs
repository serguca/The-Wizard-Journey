...
namespace UIAssistant
{
    ...
    [AddComponentMenu("UI Assistant/Colored Dropdown"), RequireComponent(typeof(GraphicColorizerGroup)), DisallowMultipleComponent]
    public class ColoredDropdown : TMP_Dropdown, ISelectableScalerController
    {
        #region Variables
